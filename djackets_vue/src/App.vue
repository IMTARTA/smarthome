  ...
  <div id="wrapper">
    <nav class="navbar is-dark">
      <div class="navbar-brand">
        <router-link to="/" class="navbar-item"><strong>SmartHome</strong></router-link>
      ...
      <div class="navbar-menu" id="navbar-menu" v-bind:class="{'is-active': showMobileMenu }">
        ...
        <div class="navbar-end">
          <router-link to="/summer" class="navbar-item">全部商品</router-link>
          <router-link to="/winter" class="navbar-item">场景</router-link>
